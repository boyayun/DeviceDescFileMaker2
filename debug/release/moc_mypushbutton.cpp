...
#include "../../code/functions/mypushbutton.h"
...
QT_MOC_LITERAL(3, 28, 15), // "FunctionStruct*"
QT_MOC_LITERAL(4, 44, 8) // "slottest"

    },
    "MyPushButton\0signalClicked\0\0FunctionStruct*\0"
    "slottest"
};
...
void MyPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalClicked((*reinterpret_cast< FunctionStruct*(*)>(_a[1]))); break;
        case 1: _t->slottest((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyPushButton::*_t)(FunctionStruct * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyPushButton::signalClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyPushButton::signalClicked(FunctionStruct * _t1)
{
