...
public:
    ...
    QString getPrimaryClass() const;
    void setPrimaryClass(const QString &value);

    int getMinorClassCode() const;
    void setMinorClassCode(const int value);

    QString getMinorClass() const;
    void setMinorClass(const QString &value);
...
private:
    ...
    QString primaryClass;   // 设备大类
    int     minorClassCode; //设备小类号
    QString minorClass;     // 设备小类
